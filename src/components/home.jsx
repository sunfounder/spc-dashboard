...
const Home = (props) => {
  ...
  const [tabIndex, setTabIndex] = useState(parseInt(window.localStorage.getItem("spc-dashboard-tabIndex")) || 0);
  ...
  const handleTabChange = (event, newValue) => {
    window.localStorage.setItem("spc-dashboard-tabIndex", newValue);
