  ...
  return (
    <Card
      ...
      chart={
        ...
        //       <PieChart key={index} theme={props.theme} detail={detail} data={mmcblk0} processorChartAmount={true} />
        //     ))} */}
        //   </div>
        // </div>
        <BarChart color="storage" detail={detail} data={diskData} />
      }
      icon={<svg aria-hidden="true" focusable="false" height="2em" fill={props.theme.svgBackgroundColor} data-prefix="fas" data-icon="hard-drive" class="svg-inline--fa fa-hard-drive fa-2x " role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path fill="currentColor" d="M0 96C0 60.7 28.7 32 64 32H448c35.3 0 64 28.7 64 64V280.4c-17-15.2-39.4-24.4-64-24.4H64c-24.6 0-47 9.2-64 24.4V96zM64 288H448c35.3 0 64 28.7 64 64v64c0 35.3-28.7 64-64 64H64c-35.3 0-64-28.7-64-64V352c0-35.3 28.7-64 64-64zM320 416a32 32 0 1 0 0-64 32 32 0 1 0 0 64zm128-32a32 32 0 1 0 -64 0 32 32 0 1 0 64 0z"></path></svg>}
      pieChart={true}
    />
  )
}
